<template>
  <div class="admin-login-bg">
    <div class="admin-login-container">
      ...
      <h2 class="admin-login-title">관리자 회원가입</h2>
      <p class="admin-login-subtitle">관리자 계정을 생성하세요</p>
      <form @submit.prevent="onRegister" class="admin-login-form">
        ...
        <input
          ...
          required
        />
        <button type="submit" class="admin-login-btn">회원가입</button>
