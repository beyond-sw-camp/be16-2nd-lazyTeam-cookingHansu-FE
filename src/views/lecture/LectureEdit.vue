         ...
         <div class="form-section">
           ...
           <div class="image-upload">
             <div class="current-image" v-if="currentThumbnail">
               ...
               <p v-if="isAutoGeneratedThumbnail">자동 생성된 썸네일</p>
               <p v-else>현재 썸네일</p>
             </div>
             <div class="upload-area" @click="triggerFileInput('thumbnail')">
               ...
               <div class="upload-content">
                 ...
                 <p class="auto-thumbnail-hint" v-if="!currentThumbnail">첫 번째 영상의 첫 장면이 자동으로 썸네일로 설정됩니다</p>
               </div>
             </div>
           </div>
         </div>
      ...
      handleThumbnailUpload(event) {
        ...
        if (file) {
          ...
          if (!allowedTypes.includes(file.type)) {
           ...
           reader.onload = (e) => {
             ...
             this.isAutoGeneratedThumbnail = false; // 수동 업로드로 변경
           };
       ...
       handleVideoUpload(event, index) {
         ...
         if (file) {
           ...
           // 첫 번째 비디오인 경우 썸네일 자동 생성
           if (index === 0 && !this.currentThumbnail) {
             this.generateThumbnailFromVideo(file);
           }
         }
              },
       
       // 비디오에서 썸네일 생성
       generateThumbnailFromVideo(videoFile) {
         ...
         video.onseeked = () => {
           ...
           this.currentThumbnail = thumbnailUrl;
           this.isAutoGeneratedThumbnail = true;
