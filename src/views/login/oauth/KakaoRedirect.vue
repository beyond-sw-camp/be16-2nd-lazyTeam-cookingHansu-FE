...
export default {
  ...
  setup() {
    ...
    const getDetailMessage = computed(() => {
      if (error.value) return '카카오 로그인 처리 중 오류가 발생했습니다.';
      return '카카오에서 받은 정보를 처리하고 있습니다.';
    });
    ...
    const handleKakaoLogin = async () => {
      try {
        ...
        // handleKakaoLogin에서 비활성화된 회원인 경우 특별한 객체를 반환하므로 체크
        ...
        error.value = err.message || 'Kakao 로그인에 실패했습니다.';
